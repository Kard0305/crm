...
class Clientes:# criando classe cliente
...
class SistemaDeCRM:#criando a classe SistemaDeCRM
    ...
    def adicionar_clientes(self):#definir o metodo adicionar cliente
        ...
        cliente = Clientes(nome, telefone,email)#cria uma estancia da classe usuario
        sql = "INSERT INTO clientes (nome, telefone, email) VALUES (%s, %s ,%s)"#inserir na tabela usuarios nome,telefone,email,
    ...
    def listar_usuario(self):#definir o metodo listar usuario
    ...
    def listar_clientes(self):#definir o metodo listar cliente
        self.cursor.execute("SELECT nome, telefone,email FROM clientes")#Executa o comando SQL para selecionar dados nome e telefone email da tabela cliente
